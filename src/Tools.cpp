...
static void AddLinkerInputs(const ToolChain &TC, const InputInfoList &Inputs,
  ...
  for (const auto &II : Inputs) {
    ...
    /* CFIXX Mod - ignore linker option -z defs */
    else if (A.getNumValues() == 2 &&
              !strcmp(A.getValue(0), "-z") &&
              !strcmp(A.getValue(1), "defs")){
      continue;
    }
    /* CFIXX Mod */
    else {
  ...
  /*CFIXX Mod - add path to our version of libc++ */
  /*
     SmallVector<char *, 2> cfixxMagic;
  cfixxMagic.emplace_back((char *)"-rpath");
  cfixxMagic.emplace_back((char *)"/home/nathan/Code/cfixx-code/release-install/lib");
  CmdArgs.append(cfixxMagic.begin(), cfixxMagic.end());
*/
...
collectSanitizerRuntimes(const ToolChain &TC, const ArgList &Args,
  ...
  StaticRuntimes.push_back("cfixx");
}
